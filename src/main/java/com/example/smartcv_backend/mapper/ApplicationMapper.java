...
public interface ApplicationMapper {
    ...
    ApplicationResponse toUserResponse(Application application);
    java.util.List<ApplicationResponse> toUserResponseList(java.util.Set<Application> applications);
